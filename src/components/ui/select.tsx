...
const SelectScrollUpButton = React.forwardRef<React.ElementRef<typeof SelectPrimitive.ScrollUpButton>, ScrollButtonProps>(
  ({ className, ...props }, ref) => (
...
const SelectScrollDownButton = React.forwardRef<React.ElementRef<typeof SelectPrimitive.ScrollDownButton>, ScrollButtonProps>(
  ({ className, ...props }, ref) => (
